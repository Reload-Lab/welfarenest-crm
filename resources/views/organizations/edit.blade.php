...
<h2 class="h4 mb-4">Modifica organizzazione</h2>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        value="{{ old('organization_type_id', $organization->organization_type_id) }}"
                        min="1"
                    >
                ...
                <div class="col-md-4">
                    <div class="form-check">
                        <input
                            ...
                            {{ old('is_split_payment', $organization->is_split_payment) ? 'checked' : '' }}
                        >
